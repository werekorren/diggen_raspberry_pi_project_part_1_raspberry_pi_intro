...
Follow the instruction in the section ''Running attached'' in the guide you find at \\{\color{blue}\href{https://projects.raspberrypi.org/en/projects/raspberry-pi-setting-up/3}{\texttt{https://projects.raspberrypi.org/en/projects/raspberry-pi-setting-up/3}}}\\until you have reached the part where you need to restart you Pi (ignore the section called ''Running headless''). Restart it!
